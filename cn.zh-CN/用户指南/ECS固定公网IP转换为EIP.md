...
-   按固定带宽计费的包年包月ECS实例，需要先将预付费的固定带宽先转换按量付费的按流量计费的带宽，再将固定公网IP转换为EIP。预付费的固定带宽先转换按量付费的按流量计费的带宽的操作，详情请参考：[包年包月实例实时降配](https://help.aliyun.com/document_detail/52574.html?spm=5176.2020520101.0.0.28d24df5gSfJGS)。 
